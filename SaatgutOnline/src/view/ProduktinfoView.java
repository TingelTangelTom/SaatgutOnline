...
/**
 * <p>
 * Die Klasse <code>ProduktinfoView</code> ist für die Zusammenstellung des <i>HTML</i>-Codes für die Einzelansicht
 * des Produkts zust&auml;ndig.
 * </p>
 * 
 * @author Simon Ankele
 * @version 1.0
...
public class ProduktinfoView
{
	...
	/**
	 * <p>
	 * Konstruktor der Klasse <code>ProduktinfoView</code>
	 * </p>
	 * <p>
	 * Der Konstruktor erstellt die Objekte <code>ProduktController</code>, <code>ProduktModel</code> und
	 * <code>HtmlAusgabe</code> und &uuml;bergibt den Klassenvariablen <i>kategorie</i> und <i>session</i> die
	 * benötigten Werte. Desweiteren werden in <i>this.resourceBundle</i> die benötigten Texte der aktuellen
	 * Sprache abgelegt.
	 * </p>
	 * 
	 * @param request
	...
	/**
	 * <p>
	 * Die Methode <code>anzeigenProduktinfo</code> liefert den <i>HTML</i>-Code f&uuml;r die Anzeige der
	 * Einzelansicht eines Produkts. Sie l&auml;sst Daten im <code>ProduktController</code> und in der
	 * <code>HtmlAusgabe</code> bearbeiten und erstellen, um den <i>HTML</i>-Code richtig darstellen zu können.
	 * </p>
	 * 
	 * @param id
	 *            - Produkt-ID des anzuzeigenden Produkts
	...
	public String anzeigenProduktinfo(int id)
	{
		...
		this.output = "<table class=\"produktinfo\">\n"
				...
				+ "</tr>\n" + "<tr>\n" + "<td class=\"produktinfo bestellnummer\">"
				+ this.resourceBundle.getString("PRODUKTNUMMER") + " " + produktModel.getProduktnummer()
				+ "</td>\n" + "</tr>\n" + "<tr>\n" + "<td class=\"produktinfo\">\n"
				+ "<table class=\"produktmerkmale\">\n";
		for (String name : merkmale.keySet())
		{
			output += "<tr><td class=\"produktmerkmale name\">" + name
					+ "</td><td class=\"produktmerkmale wert\">" + merkmale.get(name) + "</td></tr>"; // Eigenschaft
																										// 1
		}
		this.output += "</td>\n"
				+ "</table>\n"
				...
				+ "<tr>\n"
				+ "<td class=\"produktinfo preis\">"
				+ this.htmlAusgabe.outPreisformat(produktModel.getPreisBrutto())
				+ "</td>\n"
				+ "</tr>\n"
				+ "<tr>\n"
				+ "<td class=\"produktinfo preisverordnung\">"
				+ this.htmlAusgabe.outPreisverordnung(this.resourceBundle.getString("VERSANDKOSTEN"),
						produktModel.getSteuerSatz()) + "</td>\n" + "</tr>\n" + "<tr>\n"
