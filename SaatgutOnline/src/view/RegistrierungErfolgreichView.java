...
/**
 * <p>
 * Die Klasse <code>RegistrierungErfolgreichView</code> erzeugt einen <code>PrintWriter</code> und gibt gemaess
 * mittels resourcebundle uebergebener Spracheinstellungen HTML-Code aus.
 * </p>
 * 
...
public class RegistrierungErfolgreichView
{
	...
	/**
	 * Konstruktor der Klasse. Liest Session-Variable ein stellt Lokalisierung bereit.
	 * 
	 * @param request
	 * @param response
	 */
