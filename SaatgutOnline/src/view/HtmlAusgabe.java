...
/**
 * <p>Die Klasse <code>HtmlAusgabe</code> liefert R&uuml;ckgabewerte für die 
...
public class HtmlAusgabe extends HttpServlet{
	...
	/**
	 * 
	 * <p>Konstruktor der Klasse <code>HtmlAusgabe</code></p>
	 * <p>Der Konstruktor speichert das Session-Attribut <i>spracheId</i> 
	 * in der Klassenvariablen <i>sprache_id</i></p>
	 * 
	...
	/**
	 * <p>Die Methode <code>outPreisformat</code> wandelt den Übergabeparameter <i>double preis</i> 
	 * in das Preisformat der aktuell gewählten Sprache um.</p>
	 * <p>Beispiel: <i>EUR1.000,00</i> oder <i>$ 1,000.00</i>
	 * 
	 * @param preis - <i>double</i>-Wert, welcher als Preis ausgegeben wird
	...
	/**
	 * <p>Die Methode <code>outPreisformatEnglischerZusatz</code> wandelt den Übergabeparameter <i>double preis</i> 
	 * in das Preisformat US-Dollar um und setzt dieses in Klammern</p>
	 * <p>Beispiel: <i>($ 1,000.00)</i>
	 * 
	 * @param preis - <i>double</i>-Wert, welcher als Preis ausgegeben wird
	 * @return <code>String</code> liefert den formatierten Preis zurück
	 * @see model#Produktinfo
	...
	/**
	 * <p>Die Methode <code>outPreisverordnung</code> gibt einen rechtskonformen Text als <i>String</i> für die Preisangabe zurück.
	 * Er setzt sich aus der Angabe der Mehrwertsteuer und einem sichtbaren Link für die Versandkosten zusammen.</p>
	 * @param versandkosten_text - internationalisierter Name für Versandkosten
	 * @param mwst - <i>double</i>-Parameter des Prozentwertes der Mehrwertsteuer
	 * @return <i>String</i>, welcher einen rechtskonformen Text inklusive Versandkosten-Link und Mehrwertsteuer enthält
	 * 
	 * @see model#Produktliste
	 * @see model#Produktinfo
	 */
	...
	/**
	 * <p>Die Methode <code>outKurzeProduktbeschreibung</code> gibt einen rechtskonformen Text als <i>String</i> für die Preisangabe zurück.
	 * Er setzt sich aus der Angabe der Mehrwertsteuer und einem sichtbaren Link für die Versandkosten zusammen.</p>
	 *  
	 * @param mehr_anzeigen - Text für den Link zum <code>ProduktinfoView</code>
	 * @param beschreibung - Text, welcher gekürzt werden soll
	 * @param zeichen - Anzahl der Zeichen, die der Text enthalten darf
	 * @param id - Produkt-ID des Textes
	...
	/**
	 * <p>Die Methode <code>outKategoriename</code> gibt den vollen Kategorienamen zurück, welcher sich aus der Hauptkategorie und der Unterkategorie 
	 * zusammensetzt und der Datenbank-Tabelle Kategorie in der Spalte <i>kategorie_schreibung</i> befindet.</p>
	 * 
	 * @param kategorie_id der gewünschten Kategorie
	...
	/**
	 * <p>Die Methode <code>outLinkProduktinfo</code> gibt den Link inklusive der benötigten <i>GET</i>-Parameter zurück.</p>
	 * 
	 * @param linkString der <i>GET</i>-Parameter
	 * @param produkt_id des aktuellen Produktes
	...
	/**
	 * <p>Die Methode <code>outParameterLink</code> gibt die <i>GET</i>-Parameter für den Link zurück. 
	 * Dieses setzt sich aus den einzelnen Übergabeparametern und <code>Session</code>-Attributen zusammen.</p>
	 * 
	 * @param request - der aktuelle <code>HttpServletRequest</code>
	 * @param erweitertesuche - <i>boolean</i>-Wert, ob erweiterte Suche angezeigt werden soll
	 * @param suchen - <i>boolean</i>-Wert, ob die Suche gestartet werden soll
	 * @param suchbegriff - <i>String</i>-Wert des Suchbegriffs
	...
	/**
	 * <p>Die Methode <code>outParameterLink</code> gibt die <i>GET</i>-Parameter für den zurück.
	 * Dieses setzt sich aus den einzelnen Übergabeparametern und <code>Session</code>-Attributen zusammen.</p>
	 * 
	 * @param request - der aktuelle <code>HttpServletRequest</code>
	 * @param sortierspalte - Wert für Produktname (pn) oder Produktpreis (pp)
	 * @return <i>String</i> der Übergabeparameter
	 * 
	 * @see model#Produktliste
	 */
