...
/**
 * <p>
 * Die Klasse <code>NavigationsbereichView</code> stellt Html-Ausgabe-Bloecke zur Darstellung des
 * Navigationsbereichs zur Verfuegung.
 * </p>
 * 
 * @author Tom Weigelt
 * @version 1.0
...
public class NavigationsbereichView
{
	...
	/**
	 * <p>
	 * Stellt die internationalisierte Html-Ausgabe fuer den Angebote-Link zur Verfuegung
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Stellt die internationalisierte Html-Ausgabe fuer den akteull gewaehlten Angebote-Link zur Verfuegung
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Stellt die Html-Ausgabe fuer eine Hauptkategorie in der Kategorienliste des Navigationsbereiches zur
	 * Verfuegung.
	 * </p>
	 * 
	 * @param kategorieModel
	 *            - das Objekt der anzuzeigenden Kategorie als <code>KategorieModel</code>
	...
	/**
	 * <p>
	 * Stellt die Html-Ausgabe fuer die aktuell gewaehlte Hauptkategorie in der Kategorienliste des
	 * Navigationsbereiches zur Verfuegung.
	 * </p>
	 * 
	 * @param kategorieModel
	 *            - das Objekt der anzuzeigenden Kategorie als <code>KategorieModel</code>
	...
	/**
	 * <p>
	 * Stellt die Html-Ausgabe fuer eine Unterkategorie in der Kategorienliste des Navigationsbereiches zur
	 * Verfuegung.
	 * </p>
	 * 
	 * @param kategorieModel
	...
	/**
	 * <p>
	 * Stellt die Html-Ausgabe fuer die aktuell gewaehlte Unterkategorie in der Kategorienliste des
	 * Navigationsbereiches zur Verfuegung.
	 * </p>
	 * 
	 * @param kategorieModel
