package controller;
/**
 * <p>Die Klasse <code>DatenbankController</code>
 * stellt die statische Datenbankmethode 
...
public class DatenbankController {
	...
	/**
	 * Statische Methode zur Datenbankabfrage.
	 * Es wird eine Verbindung aus dem <code>ConnectionPoolController</code>
	 * verwendet.
	 * </p>
	 * @param String
	 * @return resultSet
