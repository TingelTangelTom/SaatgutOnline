...
/**
 * <p>
 * Die Klasse <code>PasswortHashController</code> kann sichere Hashes von Passwoertern erstellen und Passwoerter
 * und dazugehoerige Hashes vergleichen. Als Algorithmus PBKDF_2 (Password-Based Key Derivation Function 2) kommt
 * in Verbindung mit der SecretKeyFactory Klasse zum Einsatz. Die Anzahl an Iterationen sowie die verwendete
 * Schluessel- sowie Salt-Laenge kann intern eingestellt werden.
 * </p>
 * 
...
public class PasswortHashController
{
	 ...
	 * 
	 * @param passwort
	 *            das zu hashende Passwort als char-Array
	 * @return versalzener PBKDF2-Hash des Passworts
	 */
	public static String erstellePasswortHash(char[] passwort) throws NoSuchAlgorithmException,
	 ...
	 * 
	 * @param passwort
	 *            Das zu pruefende Passwort
	 * @param korrekterHash
	 *            Hashwert des richtigen Passworts
	 ...
	 * 
	 * @param passwort
	 *            Das zu pruefende Passwort als char-Array
	 * @param korrekterHash
	 *            Hashwert des richtigen Passworts
	 * @return true wenn das Passwort stimmt, sonst false
	 */
	public static boolean validierePasswort(char[] password, String correctHash) throws NoSuchAlgorithmException,
			InvalidKeySpecException
	{
	...
	/**
	 * Byte-Arrays werden verglichen. Diese Vergleichsmethode verhindert das extrahieren von Hashes durch
	 * Online-Timing-Angriffe, die eine spaeteres Offline-Dekodieren beabsichtigen.
	 * 
	 * @param a
	 *            erstes Byte-Array
	 * @param b
	 ...
	 *            der Salt
	 * @param iterations
	 *            Anzahl an Iterationen (Verlangsamungs-Faktor)
	 * @param bytes
	 *            Die Laenge des zu berechnenden Hashes in Bytes
	 ...
	 * 
	 * @param array
	 *            zu konvertierendes Byte-Aarray
