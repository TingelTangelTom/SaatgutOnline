...
/**
 * <p>
 * Die Klasse UrlController stellt die Methoden <code>zwischenzuspeicherndeUrlInSessionLegen()</code> und
 * <code>zwischengespeicherteUrlAusSessionHolen()</code> zur Verfügung.
 * </p>
 * <p>
 * Mittels dieser Methoden ist es moeglich, dynamisch auf die zuletzt abgespeicherte Seite, oder auch speziell auf
 * die zuletzt abgelegte Produktseite (<i>Produktliste</i> bzw. <i>Produktinfo</i>) zu verlinken.
 * </p>
 * 
 * @author Tom Weigelt
 * @version 1.0
...
public class UrlController
{
	...
	/**
	 * <p>
	 * Legt die zwischenzuspeichernde URL inklusive aller Paramater in der Session ab.
	 * </p>
	 * <p>
	 * Es wird automatisch zwischen <b>Produktseite</b> und <b>LetzteSeite</b> unterschieden: </br>enthaelt die URL
	 * den Teilstring "<b>/Produkt</b>", so wird die URL sowohl unter dem key <i>urlProduktseite</i> als auch
	 * <i>urlLetzteSeite</i> abgelegt. </br>Ist der Teilstring nicht enthalten, wird die URL nur unter
	 * <i>urlLetzteSeite</i> abgelegt.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Holt die zwischengespeicherte URL inklusive aller Parameter unter dem Key <b>'url'+seite</b> aus der Session
	 * und gibt diese als <code>String<code> zurück.
	 * </p>
	 * 
	 * @param seite
	 *            - Seite, deren URL ausgegeben werden soll (<b>LetzteSeite</b> oder <b>Produktseite</b>) als
	 *            <code>String</code>
