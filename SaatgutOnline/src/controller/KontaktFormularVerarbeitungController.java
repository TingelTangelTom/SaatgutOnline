...
/**
 * <p>Die Klasse <code>KontaktFormularVerarbeitungController</code> liest das Kontaktformular aus</br>
 * und validiert die E-Mail-Adresse.</p>
 * 
...
public class KontaktFormularVerarbeitungController {
	...
	/**
	 * <p>Der Konstruktor der Klasse <code>KontaktFormularVerabeitungController</code> versendet die vom</br>
	 * <code>KontaktFormularController</code> ausgelesenen Daten als E-Mail und ruft den</br>
	 * <code>KontaktFormularView</code> auf.</p>
	 * 
	 * @param request
	 * @param response
