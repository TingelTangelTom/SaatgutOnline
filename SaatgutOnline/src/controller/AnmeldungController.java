...
/**
 * <p>Die Klasse <code>Anmeldungcontroller</code> pruef die Anmeldedaten und leitet je nach Ergebnis an
 * entsprechende Servlets weiter.</p>
 * 
...
public class AnmeldungController {
	 ...
	 * </p>
	 * </br>Prueft die Anmeldedaten mit der Methode <code>pruefeAnmeldedaten()</code>.
	 * Die Pruefung erfolgt mehrstufig: Zunaechst wird auf formelle Gueltigkeit von
	 * Passwort und Benutzername gemaess Konfiguration.xml geprueft, erst danach wird ggfs.
	 * die Datenbank abgefragt, zunaechst Benutzername, dann ggfs. zum Schluss das Passwort.
	 * Eine erfolgreiche Anmeldung setzt die Sessionvariable "angemeldet" auf true.
	 * <br />
	 * Je nach Ergebnis der Pruefung wird auf die entsprechenden Servlets weitergeleitet:
	 * </br>- AnmeldungFehler				(Benutzername / Passwort falsch)
	 * </br>- AnmeldungRegistrierungFehler  (Benutzer nicht mit Bestaetigungslink freigeschaltet)
	 * </br>- AnmeldungErfolgreich			(Anmeldung erfolgt)	
	 * </br>
